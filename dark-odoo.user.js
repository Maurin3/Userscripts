...
(function() {
    ...
    if (false || (document.domain == "odoo.com/web" || document.domain.substring(document.domain.indexOf(".odoo.com/web") + 1) == "odoo.com/web")
        ...
        css += [
            ...
            "}",
            // Chatter
            ".close, .o_thread_message .o_mail_discussion, .o_attachment, .o_chatter_topbar, .o_mail_activity.o_field_widget, .o_form_view > .oe_chatter, .o_mail_thread .o_mail_thread_content, .o_thread_message .o_mail_discussion strong, o_chatter oe_chatter, .o_thread_window .o_mail_thread, .o_thread_composer .o_composer {",
            "    background-color: #222222;",
            "    color: #bfbfbf;",
            "}",
            ...
            "    color: #bfbfbf;",
            "}",
            ".o_content, .o_mail_thread .o_thread_date_separator .o_thread_date, .o_thread_window .o_mail_thread .o_thread_date_separator .o_thread_date {",
            "    background-color: #222222;",
            "    color: #bfbfbf;",
            "}",
            ...
            "    color: #bfbfbf;",
            "}",
            ".o_mail_discuss .o_mail_discuss_content .o_mail_thread, .o_thread_composer, .o_thread_composer:not(.o_chat_mini_composer):not(.o_chat_inline_composer) .o_composer_container, .o_mail_discuss .o_mail_discuss_content .o_mail_thread, .o_thread_composer {",
            "    background-color: #222222;",
            "    color: #bfbfbf;",
            "}",
            // Control Panel
            ...
            "    border-color: #0d0d0d;",
            "}",
            ".o_control_panel .btn-secondary, .o_control_panel .btn-secondary.disabled{",
            "    background-color: #0d0d0d;",
            "    border-color: #0d0d0d;",
            "}",
            ...
            "    color: #bfbfbf;",
            "}",
            ".o_form_view .o_form_statusbar, .o_form_view .o_form_statusbar > .o_statusbar_status, .o_form_view .o_form_statusbar > .o_statusbar_status > .o_arrow_button{",
            "    background-color: #222222;",
            "    border-color: #bfbfbf;",
            "    color: #bfbfbf;",
            "}",
            ...
            "    color: #FFFFFF;",
            "}",
            ".o_form_view .o_form_statusbar > .o_statusbar_status > .o_arrow_button.btn-primary.disabled:before,.o_form_view .o_form_statusbar > .o_statusbar_status > .o_arrow_button.btn-primary.disabled:after {",
            ...
            "    color: #bfbfbf;",
            "}",
            ".o_list_view .o_data_row.o_selected_row > .o_data_cell:not(.o_readonly_modifier) .o_input , .o_view_nocontent .o_nocontent_help > p:first-of-type {",
            "    background-color: #222222;",
            "    border-color: #222222;",
            "    color: #bfbfbf;",
            "}",
            ...
            ".o_lunch_kanban .o_lunch_kanban_banner , .o_kanban_with_searchpanel .o_search_panel, .list-group-item {",
            "    background-color: #222222;",
            "    color: #bfbfbf;",
            "}",
